...
#else
        {
            __m256i r0 = SIMD::load2_m128i_AVX(raw +  3, raw +  41);
            __m256i r1 = SIMD::load2_m128i_AVX(raw + 22, raw +  60);
            __m256i r2 = SIMD::load2_m128i_AVX(raw + 79, raw + 117);
            __m256i r3 = SIMD::load2_m128i_AVX(raw + 98, raw + 136);
...
YM_FORCE_INLINE void i64_to_dec_u8_x64_AVX512BW(char* raw, const __m512i* T, upL_t blocks){
    ...
    do{
        ...
        SIMD::store2_m128i_AVX(raw +  3, raw +  41, _mm512_castsi512_si256(z0));
        SIMD::store2_m128i_AVX(raw + 22, raw +  60, _mm512_castsi512_si256(z1));
        SIMD::store2_m128i_AVX(raw + 79, raw + 117, _mm512_extracti64x4_epi64(z0, 1));
        SIMD::store2_m128i_AVX(raw + 98, raw + 136, _mm512_extracti64x4_epi64(z1, 1));
#endif
