...
#pragma once
#ifndef ydv_DigitViewer_DigitHash_x64_AVX512VNNI_IPP
#define ydv_DigitViewer_DigitHash_x64_AVX512VNNI_IPP

...
#include "DigitHash_x64_AVX512-VNNI.h"
...
hash_t accumulate(hash_t hash_in, const char* raw_digits, upL_t digits){
    ...
    if constexpr (radix == 10){
        ...
        hash = hash_dec_raw_d128_AVX512VNNI(hash, reinterpret_cast<const __m512i*>(raw_digits), blocks);
